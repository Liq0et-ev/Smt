...
country per request). **Verified against live data** -- testing surfaced
and fixed two real data-quality bugs along the way (see the task doc),
plus one documented, unresolved limitation (state-reported countries'
